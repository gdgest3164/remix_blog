...
type TToken = string;
export const AuthServiceFetchWrapper = async (method: "POST" | "GET" | "PUT" | "DELETE" = "POST", path: string, body?: any, token?: TToken) =>
...
export const refreshAccessToken = async ({ refreshToken }: { refreshToken: TToken }) => {
